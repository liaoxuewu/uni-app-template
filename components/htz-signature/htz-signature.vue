<template>
  <view class="htz-signature-body">
    <view class="htz-signature-top">
      <text>手写板</text>
      <text class="htz-signature-close" @click="closeSignature">关闭</text>
    </view>
    ...
    <cover-view class="htz-signature-color-main" v-if="colorShow">
      <cover-view
        ...
        :key="index"
      >
        <cover-image class="htz-signature-color-item-icon" src="../../static/htz-signature/on.png"> </cover-image>
      </cover-view>
    </cover-view>
...
<script>
  export default {
    ...
    methods: {
      ...
      closeSignature() {
        this.$emit('update:isShowSignature', false)
