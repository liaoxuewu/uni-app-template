 ...
 * @Author liaoxuewu
 * @create 2022/4/12 11:13
 -->
<template>
  <view>
    <view class="echarts" :prop="option" :change:prop="echarts.update" id="echarts"></view>
    <!--    <uni-echarts :id=id :option="option" style="height: 400px;"></uni-echarts>-->
  </view>
</template>
  ...
  export default {
  	...
  	mounted() {
  		if (typeof window.echarts === 'object') {
  			...
  			script.src = './common/api/untils/echarts.min.js'
